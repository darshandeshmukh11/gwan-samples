//modified version of kv_bench.c that improves the speed of SQLite
...
#define ITEM_SIZE   12
#define NBR_ROUNDS  1.0 // using a double increases the precision
...
//create a prepared statement once and
//reset the statement, clear bound variables, and
//bind variables
//only accepts char* parameters
...
int main(int argc, char **argv)
{
   ...
   // -------------------------------------------------------------------------
   {
      ...
      //extra settings to speed up SQLITE
