...
extern jsn_t *jsn_add(jsn_t *node, char *name, int type, double value)
{
   jsn_t*(*p_jsn_add)(jsn_t *node, char *name, int type, double value) =
   (jsn_t*(*)(jsn_t *node, char *name, int type, double value))
   _jsn_add;
